@echo off
echo Starting Fresh UI Analytics Dashboard...
...
if not exist "streamlit_linkedin_dashboard.py" (
    echo ERROR: Dashboard script not found in current directory.
    echo Expected: streamlit_linkedin_dashboard.py
...
echo Running dashboard from: %CD%
echo.
