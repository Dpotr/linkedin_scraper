@echo off
echo Starting Legacy Analytics Dashboard...
...
REM Check if Legacy Analytics script exists
if not exist "streamlit_linkedin_scraper.py" (
    echo ERROR: Legacy Analytics script not found in current directory.
    echo Expected: streamlit_linkedin_scraper.py
...
echo Running Legacy Analytics from: %CD%
echo NOTE: This is the deprecated dashboard. Consider using run_fresh_dashboard.bat instead.
echo.
